		                    ...
		                    <div class="item-img">
		                      <div class="item-img-info"><a href="${pageContext.request.contextPath}/DetaiProduct?pid=${i.IDPhukien}" title="Retis lapen casen" class="product-image"><img src="${i.cover}" alt="Retis lapen casen"></a>
		                        ...
		                        <div class="actions">
		                          ...
		                          <div class="add_cart">
		                            <a href="${pageContext.request.contextPath }/cart?action=buy&id=${i.IDPhukien }"><button class="button btn-cart" type="button" data-toggle="tooltip" data-placement="right" title="" data-original-title="Add to Cart"><span>Add to Cart</span></button></a>
		                          </div>
		                        </div>
		                        <div class="rating">
		                          <div class="ratings">
